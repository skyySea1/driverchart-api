...
async function restoreCapitalizedRoles() {
  ...
  snapshot.forEach(doc => {
    ...
    if (data.role && typeof data.role === 'string') {
      ...
      switch(lower) {
        case 'admin': capitalized = 'Admin'; break;
        case 'manager': capitalized = 'Manager'; break;
        case 'dispatcher': capitalized = 'Dispatcher'; break;
        case 'auditor': capitalized = 'Auditor'; break;
        case 'viewer': capitalized = 'Viewer'; break;
      }
